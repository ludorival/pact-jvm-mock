...
class DeterministicPactTest {
    ...
    fun `should throw error when recording same interaction twice`() {
        given {
            ...
            assertEquals("""The interaction with description "should throw error when recording same interaction twice" has changed generated by test "should throw error when recording same interaction twice" in file "DeterministicPactTest"
The changes are:
